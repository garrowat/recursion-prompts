...
var palindrome = function(string) {
        if (string.length <= 1) return true; // base case: if the string is now empty, or contains only the middle character
